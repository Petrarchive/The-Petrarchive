...
let sideLeft = (d, i, dimensions) => {        
    ...
    start = center
    end = [-((dimensions.width / 2) - 5), -(dimensions.height - 20 - (margin * (dimensions.quireLength - 1 - dimensions.folioIndex)))]
...
let wrapSideLeft = (d, i, dimensions) => {
    ...
    start = center
    end = [-(   (dimensions.width / 2) - 5), .6 * -(dimensions.height - 20 - (margin * (dimensions.quireLength - 1 - dimensions.folioIndex)))]
